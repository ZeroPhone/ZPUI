...
apt-get install python3 python3-pip python3-smbus python3-dev python3-pygame python3-pillow libjpeg-dev python3-serial nmap python3-gi rsync libfreetype6-dev
