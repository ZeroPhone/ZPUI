...
def launch(name=None):
    ...
    if name != None:
        name = name.rstrip(
            '/')  # If using autocompletion from main folder, it might append a / at the name end, which isn't acceptable for load_app
        try:
...
if __name__ == "__main__":
    ...
    parser.add_argument('-a', '--app', action="store", help="Launch ZPUI with a single app loaded (useful for testing)",
                        default=None)
